...
win.window({title:_297,noheader:(_297?false:true),width:300,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,closable:false,onClose:function(){//去除关闭按钮
setTimeout(function(){
win.window("destroy");
},100);
}});
...
var _351=_317(_34c);
if(_351){
if(_350[0]==_351[0]){//标签相同判断
_315(_34c);
//return;点击同个标签可以重新加载
}
if(opts.onBeforeSelect.call("",_34c,_34d)==false){//增加selectbefor判断
return;
}
...
},onBeforeSelect:function(_1000,_1001){
}};
})(jQuery);
(function($){
var _37d=false;
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{border:false,sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:false,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:0,rowEvents:{mouseover:_5d1(true),mouseout:_5d1(false),click:_5d9,dblclick:_5e3,contextmenu:_5e7},rowStyler:function(_76a,_76b){
...
$.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,{valueField:"value",textField:"text",groupField:null,editable:false,groupFormatter:function(_95d){
return _95d;
